...
{
    fprintf(stderr, "USAGE: %s [-l hints_limits] [-p dictionary_path] [-i input] [-o output]\n", program_name);
    ...
    fprintf(stderr, "dictionary_path - path to the text file with dictionary data [string, default - %s]\n", DEFAULT_DICTIONARY_FILE_PATH);
